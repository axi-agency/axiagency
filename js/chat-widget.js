(function () {
  ...
  var css = [
    ...
    '  padding:10px 16px;word-break:break-word;overflow-wrap:anywhere;white-space:pre-wrap;',
    '}',
    '.axi-user .axi-bubble{',
    ...
    '  .axi-msg{max-width:78%;}',
    '  .axi-bubble{font-size:15px;padding:10px 16px;line-height:1.5;}',
